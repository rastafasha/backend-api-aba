...
-- Tiempo de generación: 02-02-2024 a las 15:22:27
...
(3, 7, 'asd234', 1, 1, '[{\"cde\": true, \"mnl\": true, \"referal\": true, \"medical_notes\": true, \"doctor_referal\": true}]', 'dasads', 'dasdas', 'dasdas', 'dasdas', 'dsads', '[{\"baseline_level\": \"Maladaptives dsadsa\", \"initial_interesting\": 34, \"maladaptive_behavior\": \"Maladaptives\", \"topografical_definition\": \"dsadsadsadas\"}]', 'dasdas', '[{\"ados\": true, \"vineland_behavior_rating_scale\": true, \"functional_assessment_interview_completed\": true}]', '[{\"behavior\": \"dadas\", \"hypothesized_functions\": \"dsaad\", \"prevalent_setting_event_and_atecedent\": \"dsasd\"}, {\"behavior\": \"dasdasd\", \"hypothesized_functions\": \"asdas\", \"prevalent_setting_event_and_atecedent\": \"saddas\"}, {\"behavior\": \"dasdasdsa\", \"hypothesized_functions\": \"das\", \"prevalent_setting_event_and_atecedent\": \"dasdsa\"}]', '[{\"dra\": \"dasds\", \"dro\": \"dasad\", \"ncr\": \"dsadas\", \"pairing\": \"asads\", \"shaping\": \"dsada\", \"chaining\": \"dsaad\", \"redirection\": \"das\", \"response_block\": \"dasa\", \"premack_principal\": \"dasad\", \"errorless_teaching\": \"dsadasdsa\"}]', NULL, '2024-02-01 03:35:32', '2024-02-02 17:33:14', NULL);
...
CREATE TABLE `reduction_goals` (
  ...
  `status` enum('on hold','initiated','mastered') DEFAULT NULL,
  `date` timestamp NULL DEFAULT NULL,
  `lto` varchar(50) DEFAULT NULL,
  `description_lto` text,
  `status_lto` enum('on hold','initiated','mastered') DEFAULT NULL,
...
INSERT INTO `reduction_goals` (`id`, `goal_id`, `goal`, `patient_id`, `sto`, `bip_id`, `decription_goal`, `status`, `date`, `lto`, `description_lto`, `status_lto`, `date_lto`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 'Negative Self talk', 'cliente3243', 'sto1', 1, 'dasdas', 'initiated', '2024-02-07 08:00:00', NULL, NULL, 'on hold', NULL, '2024-02-02 18:23:50', '2024-02-02 18:23:50', NULL),
(2, NULL, 'Negative Self talk', 'cliente3243', NULL, 1, NULL, NULL, NULL, 'ads', 'dasdsa', 'on hold', '2024-02-08 08:00:00', '2024-02-02 18:25:45', '2024-02-02 18:25:45', NULL),
(3, 1, 'Maladaptives', 'asd234', 'STO1', 3, 'adsdsa', 'initiated', '2024-02-08 08:00:00', 'LTO!', 'dsadsa', 'initiated', '2024-02-09 08:00:00', '2024-02-02 18:33:30', '2024-02-02 18:33:30', NULL),
(4, 2, 'Maladaptives', 'asd234', 'sto2', 3, 'dassto2', 'mastered', '2024-02-08 08:00:00', NULL, NULL, NULL, NULL, '2024-02-02 18:49:30', '2024-02-02 18:49:30', NULL),
(5, NULL, 'Maladaptives', 'asd234', NULL, 3, NULL, NULL, NULL, 'lto04', 'dsa', 'mastered', '2024-02-06 08:00:00', '2024-02-02 18:50:24', '2024-02-02 18:50:24', NULL);
